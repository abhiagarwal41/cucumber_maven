...
public class LoginPage extends AbstractPage{
	...
	public WebElement getWebElement(String name){
		...
		case "EMAIL" : cssselector= "#email"; break;
		case "PASSWORD" : cssselector= "#passwd"; break;
		case "SUBMIT BUTTON" : cssselector= "#SubmitLogin"; break;
		case "ERROR MESSAGE" : cssselector= "#center_column div.alert ol li"; break;
		default:
		...
		case "SUBMIT BUTTON" : return submit_button;
		case "ERROR MESSAGE" : return error_message;
		default:
			throw new NoSuchElementException(name);
		}
	}
